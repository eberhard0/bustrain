...
const SHELL = "bt-shell-v32";
const SHELL_FILES = ["./", "index.html", "app.css?v=32", "app.js?v=32", "trips.js?v=32",
  "guide.js?v=32", "vendor/leaflet/leaflet.js", "vendor/leaflet/leaflet.css",
