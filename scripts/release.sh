...
sed -i -E "s/(app\.css|app\.js|trips\.js|sw\.js)\?v=[0-9]+/\1?v=$V/g" index.html app.js
sed -i -E "s/bt-shell-v[0-9]+/bt-shell-v$V/; s/(app\.css|app\.js|trips\.js)\?v=[0-9]+/\1?v=$V/g" sw.js
